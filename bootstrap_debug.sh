...
CFLAGS="-DDEBUG -O -gdwarf-2 -I/Library/Xsnmp/XsnmpAgentExtension.app/Headers -W -Wall -Wno-unused-parameter -Werror -mmacosx-version-min=10.5 -isysroot /Developer/SDKs/MacOSX10.5.sdk -arch i386 -arch ppc" \
